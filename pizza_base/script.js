...
const ss= (e) => document.querySelectorAll(e);

// Listagem das Pizzasas
...
pizzaJson.map((item, i) => {
    ...
    pizzaItem.querySelector('a').addEventListener('click', (e)=>{
        ...
        ss('.pizzaInfo--size').forEach((size, sizeIndex) => { 
...
ss('.pizzaInfo--cancelButton, .pizzaInfo--cancelMobileButton').forEach((i)=>{
...
s('.pizzaInfo--addButton').addEventListener('click', ()=>{    
    ...
    let identifier = pizzaJson[modalKey].id+'P'+size;
